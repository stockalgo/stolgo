"""Daily consolidation + intraday break — preset.breakout_intraday."""
...
class IntradayBreak(Strategy):
    def __init__(self) -> None:
        self._long, self._short = pa.preset.breakout_intraday(days=7)
        self._bracket = None
